...
_Generated: 2026-09-23T06:00:59.871Z_
...
Workspace `mcp.json` _(folder: Barber Connection)_

- **c:\Users\sebas\Documents\Barber Connection\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\sebas\AppData\Roaming\Code\User\mcp.json** — _File missing_
